import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, nextTick, unref, toRef, defineComponent, createElementBlock, provide, cloneVNode, h } from 'file:///Users/mac/git/nuxt-blog/node_modules/vue/index.mjs';
import { debounce } from 'file:///Users/mac/git/nuxt-blog/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs';
import { d as useNuxtApp, e as asyncDataDefaults, b as useRuntimeConfig, f as createError, g as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///Users/mac/git/nuxt-blog/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CtlgaTDw.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DFlsgtIC.mjs.map
