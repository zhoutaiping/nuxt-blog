import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, toRef, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, Suspense, Fragment, useSSRContext, createApp, mergeProps, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/mac/git/nuxt-blog/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/mac/git/nuxt-blog/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/mac/git/nuxt-blog/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/mac/git/nuxt-blog/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mac/git/nuxt-blog/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/mac/git/nuxt-blog/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/mac/git/nuxt-blog/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/mac/git/nuxt-blog/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/mac/git/nuxt-blog/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BEP-g0fi.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cmp2wE7v.mjs')
  },
  {
    name: "weekly-slug",
    path: "/weekly/:slug()",
    component: () => import('./_slug_-YTQxg0Kq.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CL8E7_Yb.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CUs5Npm1.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BEs51xP8.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-lStiA76c.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-Dt9zDa2g.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-zJEf8Kw2.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-CYo2g7ij.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CFPvGCgi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DG25WjEP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-C5wHD49x.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DlBBbFAc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-CKqPbzLP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BlJyPE4u.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BUpRYNbF.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D7mRCh_k.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white dark:bg-slate-900 transition-colors duration-200" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BfNJ_xHk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CEVecQFF.mjs'));
...
export { useRoute as a, useRuntimeConfig as b, useState as c, useNuxtApp as d, entry_default as default, asyncDataDefaults as e, createError as f, useRequestEvent as g, useRouter as h, encodeRoutePath as i, nuxtLinkDefaults as j, useColorMode as k, navigateTo as n, resolveRouteObject as r, useHead as u };
